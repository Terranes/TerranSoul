...
| [abhigyanpatwari/GitNexus](https://github.com/abhigyanpatwari/GitNexus) | PolyForm Noncommercial 1.0.0 | `docs/gitnexus-capability-matrix.md`, code-intelligence MCP tool surface design (Chunks 31.2–31.7) | Thank you for the public design of precomputed relational code intelligence, process-grouped queries, and the impact/context/rename MCP tool shapes. No source copied — studied public README + ARCHITECTURE.md only. |
