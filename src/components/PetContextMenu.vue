...
/** Sentinel used by the Mood submenu to represent the "Sitting" idle variant.
 *  This is NOT a CharacterState — selecting it sets state='idle' and pins the
 *  idle-pose rotation to the seated pose via characterStore.sittingPinned. */
