...
When connected, agents get 36 tools:

| Category | Tools |
|----------|-------|
| **Brain (19)** | `brain_health`, `brain_search`, `brain_suggest_context`, `brain_get_entry`, `brain_list_recent`, `brain_kg_neighbors`, `brain_drilldown`, `brain_summarize`, `brain_ingest_url`, `brain_ingest_lesson`, `brain_append`, `brain_failover_status`, `brain_wiki_audit`, `brain_wiki_spotlight`, `brain_wiki_serendipity`, `brain_wiki_revisit`, `brain_wiki_digest_text`, `brain_review_gaps`, `brain_session_checklist` |
