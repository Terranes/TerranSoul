...
//! 3. **Promote** high-access working entries → long-tier.
//! 4. **Decay + GC** — apply exponential decay, garbage-collect low-importance decayed entries.
//! 5. **Importance adjustment** — boost frequently accessed, demote stale.
//!
...
use crate::memory::store::{MemoryStore, MemoryTier};
