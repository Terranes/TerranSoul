...
use commands::{
    ...
    brain::{
        check_lm_studio_status, check_ollama_status, clear_active_brain, download_lm_studio_model,
        get_active_brain, get_brain_mode, get_brain_selection, get_embed_cache_status,
        get_lm_studio_download_status, get_lm_studio_models, get_next_provider, get_ollama_models,
        get_system_info, health_check_providers, list_free_providers, load_lm_studio_model,
        pull_ollama_model, recommend_brain_models, reset_embed_cache, set_active_brain,
        set_brain_mode, unload_lm_studio_model,
    },
    character::load_vrm,
